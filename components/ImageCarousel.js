...
class ImageCarousel extends React.Component {
  constructor(props) {
    ...
    this.state = {items: [
      {
        src: require(`../../public/images/1920x1080_Art_1.png?resize&sizes[]=300&sizes[]=600&sizes[]=1000`),
        active: "active"
      },
      {
        src: require(`../../public/images/1920x1080_Art_2.png?resize&sizes[]=300&sizes[]=600&sizes[]=1000`),
        active: ""
      },
      {
        src: require(`../../public/images/1920x1080_Art_3.png?resize&sizes[]=300&sizes[]=600&sizes[]=1000`),
        active: ""
      },
      {
        src: require(`../../public/images/1920x1080_Art_4.png?resize&sizes[]=300&sizes[]=600&sizes[]=1000`),
        active: ""
      },
      {
        src: require(`../../public/images/1920x1080_Art_5.png?resize&sizes[]=300&sizes[]=600&sizes[]=1000`),
        active: ""
      }
    ]};
